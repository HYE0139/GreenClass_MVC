                ...
                <div class="d-inline-flex flex-grow-1 flex-shrink-0">
                    <nav class="d-flex flex-grow-1 flex-row justify-content-end">
                        ...
                        <div class="d-inline-flex me-3">
                            <a href="#" id="navDropdownMenuNewFeed" data-bs-toggle="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navDropdownMenuNewFeed">
                                <li>
                        ...
                        <div class="d-inline-flex dropdown"> 
                            <a href="#" role="button" id="navDropdownMenuProfile" data-bs-toggle="dropdown" aria-expanded="false" class="header_profile">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navDropdownMenuProfile">
                                <li>
