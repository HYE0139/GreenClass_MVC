            ...
            <div class="d-flex flex-row">            
                    ...
                    <div class="flex-grow-1 d-flex flex-column justify-content-evenly">
                        <div>
                            ...
                            <?php } else { ?>
                            <button type="button" id="btnFollowToo" data-follow="0" class="btn btn-primary btnFollow <?= $follower && !$following ? "" : "d-none" ?> ">맞팔로우 하기</button>
                            <button type="button" id="btnFollow" data-follow="0" class="btn btn-primary btnFollow <?= !$follower && !$following ? "" : "d-none" ?> ">팔로우</button>
                            <button type="button" id="btnCancel" data-follow="1" class="btn btn-outline-secondary btnFollow <?= $following ? "" : "d-none" ?> ">
